            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <h1 class="brand-heading">Nous sommes<br>Jack Russell</h1>
                        <p class="intro-text">Nous avons d&eacute;cid&eacute; de cr&eacute;er Jack Russell pour apporter une r&eacute;ponse nouvelle au march&eacute; et revaloriser le m&eacute;dia <?php echo EMAIL_SING_MIN; ?>, alors que les taux d&apos;ouverture et de clic baissent saison apr&egrave;s saison.</p>
