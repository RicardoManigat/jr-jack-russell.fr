    ...
    <section id="footer">
					...
					<div class="col-xs-12" style="padding-left: 0px !important;">
						...
						<svg version="1.1" id="logo_footer" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 120.5 51.2" enable-background="new 0 0 120.5 51.2" xml:space="preserve" width="300" class="logo-foot">
                            ...
                            <path fill="#FFFFFF" d="M69.5,28.4l1-1.2c0.7,0.6,1.4,0.9,2.2,0.9c0.7,0,1.1-0.3,1.1-0.7v0c0-0.4-0.3-0.6-1.5-1
                                ...
                                c0,0.5,0.3,0.7,1.6,1c1.5,0.4,2.4,0.9,2.4,2.2v0c0,1.5-1.1,2.3-2.7,2.3C71.6,29.6,70.4,29.2,69.5,28.4z"></path>
                            <path fill="#FFFFFF" d="M76.8,28.4l1-1.2c0.7,0.6,1.4,0.9,2.2,0.9c0.7,0,1.1-0.3,1.1-0.7v0c0-0.4-0.3-0.6-1.5-1
                                ...
                                c0,0.5,0.3,0.7,1.6,1c1.5,0.4,2.4,0.9,2.4,2.2v0c0,1.5-1.1,2.3-2.7,2.3C78.8,29.6,77.7,29.2,76.8,28.4z"></path>
                            <path fill="#FFFFFF" d="M84.7,22.1h5.6v1.5h-4V25h3.5v1.5h-3.5v1.6h4.1v1.5h-5.7V22.1z"></path>
                            <path fill="#FFFFFF" d="M92.4,22.1H94v6h3.7v1.5h-5.4V22.1z"></path>
                            <path fill="#FFFFFF" d="M99.5,22.1h1.6v6h3.7v1.5h-5.4V22.1z"></path>
                            <path fill="#FFFFFF" d="M57.8,26.9c1-0.4,1.6-1.1,1.6-2.3v0c0-0.7-0.2-1.3-0.6-1.7c-0.5-0.5-1.2-0.8-2.2-0.8h-3.4v7.5h1.6v-6h1.6
                                c0.8,0,1.3,0.4,1.3,1.1v0c0,0.6-0.5,1.1-1.3,1.1h-1.3l2.6,3.8h1.9L57.8,26.9z"></path>
                            <path fill="#FFFFFF" d="M33.6,8c-10-0.2-18.2,8-18,18c0.2,9.4,7.9,17.1,17.3,17.3c10,0.2,18.2-8,18-18C50.7,15.8,43,8.1,33.6,8z"></path>
                            <path fill="#010202" d="M22.2,26.9c0,0.9-0.3,1.5-0.7,2c-0.5,0.5-1.1,0.7-1.9,0.7c-1.2,0-1.9-0.5-2.4-1.1l1-1.2
                                c0.4,0.5,0.8,0.7,1.4,0.7c0.6,0,1-0.4,1-1.2v-4.8h1.7V26.9z"></path>
                            <polygon fill="#010202" points="29.7,29.5 27.5,24 25.2,29.5 23.5,29.5 26.7,22 28.3,22 31.5,29.5 "></polygon>
                            <path fill="#010202" d="M36.2,29.7c-2.2,0-3.8-1.7-3.8-3.8v0c0-2.1,1.6-3.9,3.9-3.9c1.4,0,2.3,0.5,2.9,1.2l-1,1.2
                                ...
                                C38.5,29.1,37.6,29.7,36.2,29.7z"></path>
                            <polygon fill="#010202" points="42.7,25.2 42.7,25.3 42.7,29.5 41.1,29.5 41.1,22.1 42.7,22.1 "></polygon>
				...
				<div class="col-md-4">
					...
					<div class="col-xs-12 social-cc">
						...
						<g>
							<g>
								<path  class="social-icon" fill="#FFFFFF" d="M357.8,0h-53.3c-40.8,0-70.1,9.7-87.9,29c-17.8,19.4-26.7,47.9-26.7,85.6v35.9c0,9.5-7.7,17.2-17.2,17.2
						...
						<a href="https://www.linkedin.com/company/10572937" target="_blank">
						<svg version="1.1" id="logo_linkedin" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve" width="25" class="social-icon">
<g>
	<path  class="social-icon" id="LinkedIn" fill="#FFFFFF" d="M512,311.3v189.3H402.3V324c0-44.4-15.9-74.6-55.6-74.6c-30.3,0-48.4,20.4-56.3,40.1
		...
		h0.7c38.3,0,62.1-25.4,62.1-57.1C122.8,36,99.7,11.4,62.1,11.4z M6.5,500.6h109.7V170.5H6.5V500.6z"/>
		              ...
		              <a href="https://twitter.com/creativeemails" target="_blank">				
						<svg version="1.1" id="logo_twitter" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve" width="25" class="social-icon">
<g>
	<g>
		<path  class="social-icon" fill="#FFFFFF" d="M512,97.3c-18.8,8.4-39.1,14-60.3,16.5c21.7-13,38.3-33.6,46.2-58.1c-20.3,12-42.8,20.8-66.7,25.5
			...
			C480.1,136.8,498,118.3,512,97.3z"/>
				...
				<div class="col-md-4">
                    <div class="col-md-8 col-md-offset-4 col-xs-12" id="pige-cta">
						<a href="./pige-email.php"><b>D&Eacute;COUVRIR LA PIGE <?php echo $words['mEmail']; ?></b></a>
					</div>
                </div>
            </div>
            </section>